...
[fourTCMr_idx_best, fourTCMr_time_best, minDV] = tcm_index_gradient_vector_search(x, t, stm_t, fourTCMr_idx_best, 2, simparams);
...
[fourTCMr_idx_best, fevals] = random_unit_search(x, t, stm_t, fourTCMr_idx_best, startIdx, simparams);

% Gradient one more time, final check for a single direction
[fourTCMr_idx_best,fourTCMr_time_best,minDV] = tcm_index_gradient_vector_search(x, t, stm_t, fourTCMr_idx_best, startIdx, simparams);

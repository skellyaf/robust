function [tcm_time_combined, tcm_idx_combined, min_tcm_dv_total, P_i_minus, P_i_plus, event_is_tcm, tcm_dv_each] = opt_multiple_tcm(x, t, stm_t, simparams)
...
%         [stm_i0t, stt_i0t, x_i_f0t, x_t0t, stm_t_eval, stt_t_it, t_eval, t_s_eval, stm_t_i0t]  = createStateStmSttHistory(xt(:), simpar2);
    ...
    if i == 1
        ...
        event_is_tcm = [true(length(tcm_time),1); false];
    else
        ...
        event_is_tcm = [event_is_tcm; true(length(tcm_time),1); false];
    end

function [tcm_min, tcm_time, dvR3sigma_tr, dvV3sigma_tr, dvR3sigma_i, dvV3sigma_i, P_tcm1, P_tcm2, tcm_total_t, dvR3sigma] = tcmPair_rv(x, t, stm_t, deltaVs_nom, simparams)

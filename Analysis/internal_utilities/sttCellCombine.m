function [stm_combined, stt_combined] = sttCellCombine(stm_t_i, stt_t_i, t, t_s, total_idx_start, total_idx_end)
...
if ~skip
    ...
    for i = seg_t_start:seg_t_end
        ...
        cell_idx_end = find_cell_t_i_idx(t,t_s,stt_t_i,idx_end);
        ...
        if total_idx_start > seg_idx_start
            ...
            cell_idx_start = find_cell_t_i_idx(t,t_s,stt_t_i,total_idx_start);
    
            stm_i_i0 = stm_t_i{i}(:,:,cell_idx_start);
            stm_i0_i = -J * stm_i_i0' * J;

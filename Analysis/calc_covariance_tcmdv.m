function [P_target, tcm_dv_total, tcm_dv, P_i_minus, P_i_plus] = calc_covariance_tcmdv(x, t, t_s, stm_t, tcm_time, vel_disp_flag, deltaV, P_i, range, simparams)
...
%     event_idxs = find(event_idx_logical);
    ...
    %%%%%%%%%%%% was here fixing the STM indexing

...
% init_fn = './init_traj_files/init_sim_nrho_rdvz_2dv_tcmAtSegIntersection_lead7'; % case 1, beginning with 2 tcm opt, pr,max changed to 100m
% init_fn = './init_traj_files/init_sim_nrho_rdvz_2dv_tcmAtSegIntersection_lead8'; % case 1, beginning with 2 tcm opt, pr,max changed to 100m
init_fn = './init_traj_files/init_sim_nrho_rdvz_2dv_tcmAtSegIntersection_lead9'; % case 1, beginning with 2 tcm opt, pr,max changed to 100m

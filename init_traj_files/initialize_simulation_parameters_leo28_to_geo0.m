...
% simparams.sig_pos = 0;
% simparams.sig_vel = 0;
% simparams.sig_pos = .000001 / 1e3; % 
% simparams.sig_vel = .0000001 / 1e3; % 
% Small
...
% TCM execution error
% simparams.sig_tcm_error = .000001 / 1e3 * 3600; % Velocity 1 sigma = 0 cm/s
...
simparams.seg1_coast_fraction = .25; % percent of orbital period to coast in the first segment for initial segment guess
...
simparams.segn_coast_fraction = .25; % percent of orbital period to coast in the last segment for initial segment guess
...
coe_init.inc = 28; % inclination, deg
...
coe_init.arglat = 90; % deg, angle between ascending node and satellite position (only for circular inclined orbits)

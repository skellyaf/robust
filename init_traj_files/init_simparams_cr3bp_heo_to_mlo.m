...
simparams.n = 15; % number of trajectory segments
...
simparams.seg1_coast_fraction = 0.025; % percent of orbital period to coast in the first segment for initial segment guess
...
simparams.T0 = T_xfer/ndTime2sec;

simparams.x_init = stateProp(x_xfer_t(end,:)', - simparams.T0 * simparams.seg1_coast_fraction, simparams);
...
x_xfer = subdivide_segment(x_tli_t, t_tli, n);

simparams.x0(:,simparams.maneuverSegments(1):simparams.maneuverSegments(2)-1) = x_xfer;

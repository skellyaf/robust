...
% TCM execution error
% simparams.sig_tcm_error = 0; % Velocity 1 sigma = 0 cm/s
% simparams.sig_tcm_error = .01 / 1e3 * 3600; % Velocity 1 sigma = 1 cm/s
...
coe_init.arglat = 180; % deg, angle between ascending node and satellite position (only for circular inclined orbits)

...
simparams.maneuverSegments = [2, 6, simparams.n]; % the nodes with an impulsive maneuver allowed / segments with an impulsive maneuver at their beginning

% Nodes where the position dispersion is constrained to simparams.P_max_r
simparams.P_constrained_nodes = simparams.maneuverSegments(2:end);

% Maximum number of TCMs
simparams.max_num_TCMs = 8;
...
simparams.optoptions.OptimalityTolerance = 2e-5;

...
simparams.seg1_coast_fraction = 0.3; % percent of orbital period to coast in the first segment for initial segment guess
...
simparams.optoptions.StepTolerance = 1e-12; % use with sqp

...
simparams.corrected_nominal_dvs = logical([0 1 1]);
...
% load('C:\Users\skell\OneDrive - USU\Documents\code_repos\robust\sims\from_aries\20240222_1700.57_eed_llo_3dv_TcmAtNodes_robust_largerError_noNomCorr\workspace.mat','x_opt')
load('eed_leo_planar_smallellipse.mat');
simparams.maneuverSegments = [2, 16, 28];
...
[x_new, simparams] = insert_additional_segments(simparams.x0, simparams, 4, 3);
simparams.x0 = x_new;

[x_new, simparams] = insert_additional_segments(simparams.x0, simparams, 10, 3);
simparams.x0 = x_new;

[x_new, simparams] = insert_additional_segments(simparams.x0, simparams, 15, 2);
simparams.x0 = x_new;

[x_new, simparams] = insert_additional_segments(simparams.x0, simparams, 17, 2);
simparams.x0 = x_new;
